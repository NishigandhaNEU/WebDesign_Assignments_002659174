...
function WeatherContainer() {
  ...
  function refreshData() {
    const _url = `http://api.openweathermap.org/data/2.5/forecast?q=${cityName}&units=imperial&APPID=4e6847f3fa82b4407ef55b7901043aea`;
    fetch(_url)
      .then((res) => res.json())
      .then((data) => {
  ...
  return (
    <div className="container-fluid">
      <br></br>
      <h2>{cityName} Climate Prediction Report</h2>
